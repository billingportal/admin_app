...
namespace BillingPortalClient.Controllers
{
  public class BaseController : Controller
  {
    ...
    protected Uri baseAddress = new Uri( "https://billingportalapis.azurewebsites.net/api/" );
    // protected string baseUrl = "https://localhost:7069/";
    // protected Uri baseAddress = new Uri( "https://localhost:7069/api/" );
