...
namespace BillingSystem.Service
{
  ...
  public partial class Client
  {
    ...
    public virtual Task<Admin> GetAdminProfileAsync(int id)
    {
        return GetAdminProfileAsync(id, CancellationToken.None);
    }

    public virtual async Task<Admin> GetAdminProfileAsync(int id, CancellationToken cancellationToken)
    {
        if (id == null)
        ...
        using (var request_ = new HttpRequestMessage())
        {
            ...
            using (var response_ = await _httpClient.SendAsync(request_, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
            {
    ...
    public virtual Task<ICollection<Admin>> GetAllAdminUserAsync()
    {
        return GetAllAdminUserAsync(CancellationToken.None);
    }

    public virtual async Task<ICollection<Admin>> GetAllAdminUserAsync(CancellationToken cancellationToken)
    {
        var urlBuilder_ = new StringBuilder();
        ...
        using (var request_ = new HttpRequestMessage())
        {
            ...
            using (var response_ = await _httpClient.SendAsync(request_, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
            {
                ...
                if (status_ == 200)
                {
                    var objectResponse_ = await ReadObjectResponseAsync<ICollection<Admin>>(response_, headers_, cancellationToken).ConfigureAwait(false);
                    if (objectResponse_.Object == null)
                    {
                        throw new ApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                    }
    ...
    public virtual Task<AdminPermission> GetAdminPermissionsAsync(int adminId)
{
    return GetAdminPermissionsAsync(adminId, CancellationToken.None);
}

public virtual async Task<AdminPermission> GetAdminPermissionsAsync(int adminId, CancellationToken cancellationToken)
{
    if (adminId == null)
        throw new ArgumentNullException(nameof(adminId));

    var urlBuilder_ = new StringBuilder(BaseUrl?.TrimEnd('/') ?? "").Append($"/api/Admin/GetAdminPermissions/{Uri.EscapeDataString(ConvertToString(adminId, CultureInfo.InvariantCulture))}");
...
public virtual Task<bool> SaveAdminPermissionsAsync(AdminPermission body)
{
    return SaveAdminPermissionsAsync(body, CancellationToken.None);
}

public virtual async Task<bool> SaveAdminPermissionsAsync(AdminPermission body, CancellationToken cancellationToken)
{
    var urlBuilder_ = new StringBuilder(BaseUrl?.TrimEnd('/') ?? "").Append("/api/Admin/SaveAdminPermissions");

    using (var request_ = new HttpRequestMessage())
    {
        using (var memoryStream = new MemoryStream()) // Create MemoryStream instance
        {
            await System.Text.Json.JsonSerializer.SerializeAsync(memoryStream, body, _settings.Value, cancellationToken); // Use System.Text.Json.JsonSerializer
            memoryStream.Seek(0, SeekOrigin.Begin); // Reset position to beginning

            var content_ = new StreamContent(memoryStream); // Use the serialized content from MemoryStream
    ...
    public virtual Task<ICollection<Region>> GetAllRegionsAsync()
{
    return GetAllRegionsAsync(CancellationToken.None);
}

public virtual async Task<ICollection<Region>> GetAllRegionsAsync(CancellationToken cancellationToken)
{
    var urlBuilder_ = new StringBuilder(BaseUrl?.TrimEnd('/') ?? "").Append("/api/Admin/GetAllRegions");

    using (var request_ = new HttpRequestMessage(HttpMethod.Get, urlBuilder_.ToString()))
    {
        request_.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("text/plain"));
        ...
        using (var response_ = await _httpClient.SendAsync(request_, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
        {
            ...
            {
                var objectResponse_ = await ReadObjectResponseAsync<ICollection<Region>>(response_, response_.Headers.ToDictionary(h_ => h_.Key, h_ => h_.Value), cancellationToken).ConfigureAwait(false);
                if (objectResponse_.Object == null)
                    throw new ApiException("Response was null which was not expected.", (int)response_.StatusCode, objectResponse_.Text, response_.Headers.ToDictionary(h_ => h_.Key, h_ => h_.Value), null);
            ...
            {
                var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                throw new ApiException("The HTTP status code of the response was not expected (" + (int)response_.StatusCode + ").", (int)response_.StatusCode, responseData_, response_.Headers.ToDictionary(h_ => h_.Key, h_ => h_.Value), null);
            }
        }
    }
}

public virtual Task<ICollection<AdminRegion>> GetAdminRegionsByAdminIdAsync(int adminId)
{
    return GetAdminRegionsByAdminIdAsync(adminId, CancellationToken.None);
}

public virtual async Task<ICollection<AdminRegion>> GetAdminRegionsByAdminIdAsync(int adminId, CancellationToken cancellationToken)
{
    if (adminId == null)
        throw new ArgumentNullException(nameof(adminId));

    var urlBuilder_ = new StringBuilder(BaseUrl?.TrimEnd('/') ?? "").Append($"/api/Admin/GetAdminRegionsByAdminId/{Uri.EscapeDataString(ConvertToString(adminId, CultureInfo.InvariantCulture))}");
    ...
    using (var request_ = new HttpRequestMessage(HttpMethod.Get, urlBuilder_.ToString()))
    {
        ...
        using (var response_ = await _httpClient.SendAsync(request_, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
        {
            ...
            if ((int)response_.StatusCode == 200)
            {
                var objectResponse_ = await ReadObjectResponseAsync<ICollection<AdminRegion>>(response_, response_.Headers.ToDictionary(h_ => h_.Key, h_ => h_.Value), cancellationToken).ConfigureAwait(false);
                if (objectResponse_.Object == null)
                    throw new ApiException("Response was null which was not expected.", (int)response_.StatusCode, objectResponse_.Text, response_.Headers.ToDictionary(h_ => h_.Key, h_ => h_.Value), null);
...
public virtual async Task<ICollection<Customer>> GetCustomersByAdminIdAsync(int adminId)
{
    return await GetCustomersByAdminIdAsync(adminId, CancellationToken.None).ConfigureAwait(false);
}

public virtual async Task<ICollection<Customer>> GetCustomersByAdminIdAsync(int adminId, CancellationToken cancellationToken)
{
    // No need to check for null adminId, as it's of type int, which can't be null

    var urlBuilder = new StringBuilder();
    urlBuilder.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append($"/api/Customer/GetCustomersByAdminId/{adminId}");
    ...
    using (var request = new HttpRequestMessage(HttpMethod.Get, urlBuilder.ToString()))
    {
        ...
        using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
        {
            ...
            if (status == 200)
            {
                var objectResponse = await ReadObjectResponseAsync<ICollection<Customer>>(response, headers, cancellationToken).ConfigureAwait(false);
    ...
    /// <returns>Success</returns>
    /// <exception cref="ApiException">A server side error occurred.</exception>
   public virtual async Task<ICollection<Payment>> GetAllPaymentsAsync(CancellationToken cancellationToken)
{
    var urlBuilder_ = new StringBuilder();
    ...
    using (var request_ = new HttpRequestMessage())
    {
        ...
        Console.WriteLine("Inside all payment services before response");
        ...
        if (!response_.IsSuccessStatusCode)
        {
            ...
            throw new ApiException(
                ...
                responseData_,
                response_.Headers.ToDictionary(h => h.Key, h => h.Value),
                null
            );
        }
        ...
        using (var jsonReader = new JsonTextReader(streamReader))
        {
            ...
            while (jsonReader.Read())
            {
                ...
                {
                    var payment = serializer.Deserialize<Payment>(jsonReader);
    ...
    public virtual Task<Ticket> GetTicketByIdAsync(int id)
    {
        return GetTicketByIdAsync(id, CancellationToken.None);
    }

    public virtual async Task<Ticket> GetTicketByIdAsync(int id, CancellationToken cancellationToken)
    {
        if (id <= 0) // Corrected condition to check if ID is valid
            throw new ArgumentNullException(nameof(id)); // Use nameof() for argument name

        var urlBuilder_ = new StringBuilder();
        urlBuilder_.Append(BaseUrl?.TrimEnd('/') ?? "").Append("/api/Ticket/GetTicketById/{id}");
        urlBuilder_.Replace("{id}", Uri.EscapeDataString(ConvertToString(id, CultureInfo.InvariantCulture)));

        using (var request_ = new HttpRequestMessage(HttpMethod.Get, urlBuilder_.ToString())) // Simplified HttpRequestMessage creation
        {
            request_.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("text/plain"));
            ...
            using (var response_ = await _httpClient.SendAsync(request_, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
            {
                var headers_ = response_.Headers.ToDictionary(h => h.Key, h => h.Value);
                ...
                {
                    var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                    throw new ApiException($"The HTTP status code of the response was not expected ({status_}).", status_, responseData_, headers_, null); // Use string interpolation
                }
            }
        }
    }
...
public virtual Task<ICollection<Ticket>> GetTicketsAsync(string location, int customerId, int accountId, int invoiceId, DateTime date1, DateTime date2)
{
    return GetTicketsAsync(location, customerId, accountId, invoiceId, date1, date2, CancellationToken.None);
}

public virtual async Task<ICollection<Ticket>> GetTicketsAsync(string location, int customerId, int accountId, int invoiceId, DateTime date1, DateTime date2, CancellationToken cancellationToken)
{
    if (location == null)
        throw new ArgumentNullException(nameof(location));

    // Changed the null checks for value types like int and DateTime to check against default values.
    ...
    var urlBuilder_ = new StringBuilder();
    urlBuilder_.Append(BaseUrl?.TrimEnd('/') ?? "").Append($"/api/Ticket/GetTickets/{location}/{customerId}/{accountId}/{invoiceId}/{date1:s}/{date2:s}");
...
public virtual Task<Ticket> UpdateTicketByAdminAsync(Ticket body)
{
    return UpdateTicketByAdminAsync(body, CancellationToken.None);
}

public virtual async Task<Ticket> UpdateTicketByAdminAsync(Ticket body, CancellationToken cancellationToken)
{
    var url = $"{BaseUrl?.TrimEnd('/')}/api/Ticket/UpdateTicketByAdmin";

    using (var request = new HttpRequestMessage(HttpMethod.Post, url))
    {
        var jsonContent = System.Text.Json.JsonSerializer.Serialize(body, _settings.Value);
        request.Content = new StringContent(jsonContent, Encoding.UTF8, "application/json");
        request.Headers.Accept.Add(MediaTypeWithQualityHeaderValue.Parse("text/plain"));

        PrepareRequest(_httpClient, request, new StringBuilder(url));
        ...
        using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
        {
            ...
            if (status == 200)
            {
                var objectResponse = await ReadObjectResponseAsync<Ticket>(response, headers, cancellationToken).ConfigureAwait(false);
                if (objectResponse.Object == null)
                {
                    throw new ApiException("Response was null which was not expected.", status, objectResponse.Text, headers, null);
                }
    ...
    /// <returns>Success</returns>
/// <exception cref="ApiException">A server side error occurred.</exception>
public virtual async Task<bool> SaveTicketAsync(TicketDTO body)
{
    return await SaveTicketAsync(body, CancellationToken.None).ConfigureAwait(false);
}

/// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
/// <returns>Success</returns>
/// <exception cref="ApiException">A server side error occurred.</exception>
public virtual async Task<bool> SaveTicketAsync(TicketDTO body, CancellationToken cancellationToken)
{
    var url = $"{BaseUrl?.TrimEnd('/')}/api/Ticket/SaveTicket";
    ...
    using (var request = new HttpRequestMessage(HttpMethod.Post, url))
    {
        ...
        using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
        {
            ...
            if (status == 200)
            {
                var objectResponse = await ReadObjectResponseAsync<bool>(response, headers, cancellationToken).ConfigureAwait(false);
                if (objectResponse.Object != null)
                {
                    return objectResponse.Object;
                }
...
public virtual async Task<ICollection<Ticket>> GetAllTicketsAsync(CancellationToken cancellationToken = default)
{
    var urlBuilder = new StringBuilder();
    urlBuilder.Append(BaseUrl?.TrimEnd('/')).Append("/api/Ticket/GetAllTickets");
    ...
    using (var request = new HttpRequestMessage(HttpMethod.Get, urlBuilder.ToString()))
    {
        ...
        Console.WriteLine("Inside all ticket services before response");
        ...
        using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
        {
            ...
            var tickets = JsonConvert.DeserializeObject<List<Ticket>>(json); // Deserialize using JsonConvert
            return tickets;
        }
    }
}
...
public virtual async Task<ICollection<Ticket>> GetTicketsByAdminIdAsync(int adminId)
{
    return await GetTicketsByAdminIdAsync(adminId, CancellationToken.None).ConfigureAwait(false);
}

public virtual async Task<ICollection<Ticket>> GetTicketsByAdminIdAsync(int adminId, CancellationToken cancellationToken)
{
    // No need to check for null adminId, as it's of type int, which can't be null
    ...
    var urlBuilder = new StringBuilder();
    urlBuilder.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append($"/api/Ticket/GetTicketsByAdminId/{adminId}");
    ...
    using (var request = new HttpRequestMessage(HttpMethod.Get, urlBuilder.ToString()))
    {
        ...
        using (var response = await _httpClient.SendAsync(request, HttpCompletionOption.ResponseHeadersRead, cancellationToken).ConfigureAwait(false))
        {
            ...
            if (status == 200)
            {
                var objectResponse = await ReadObjectResponseAsync<ICollection<Ticket>>(response, headers, cancellationToken).ConfigureAwait(false);
                if (objectResponse.Object != null)
                {
                    return objectResponse.Object;
                }
